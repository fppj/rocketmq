        ...
        switch (this.serviceState) {
            case CREATE_JUST:
                ...
                if (this.defaultMQPushConsumer.getOffsetStore() != null) {
                    ...
                    // 集群消费模式消费点位保存在broker，广播消费模式保存在本地
                ...
                /*
                 * 开启定时任务（15min）扫描消费组下缓存队列中所有超时（15min）消息，发回broker重试队列，
                 * 避免offset卡住导致消息重复消费
                 */
